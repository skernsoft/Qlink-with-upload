...
public class ListSearch extends AbstractMenuItem {

  public static final String MNEMONIC = "KW";
  private int _iIndex;
   ...
   * @throws CRCException
   */
  public ListSearch(byte[] data, int start, int len) throws CRCException {
