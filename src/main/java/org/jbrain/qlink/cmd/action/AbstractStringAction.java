...
public class AbstractStringAction extends AbstractAction {
  ...
  public AbstractStringAction(String mnemonic, String data) {
    super(mnemonic);
    _sData = data;
  }

  /** @param mnemonic */
  public AbstractStringAction(String mnemonic) {
    this(mnemonic, "");
  }
